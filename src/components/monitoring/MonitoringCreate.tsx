        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between">
            {[
              ...
              { step: 2, title: 'AI生成', description: '170枚の専門知識を活用', icon: Bot },
        ...
        <div className="card">
          <div className="p-6">
            ...
            <p className="text-sm text-gray-600 mb-6">
              以下の資料をアップロードしてください。AIが170枚の専門知識を活用してモニタリング報告書を生成します。
            </p>
            ...
            <div className="p-6">
              ...
              <div className="bg-green-50 p-4 rounded-lg mb-6">
                <p className="text-green-800 text-sm">
                  ✅ AIが170枚の専門知識を活用してモニタリング報告書を生成しました。内容を確認し、必要に応じて修正してください。手動での詳細な編集も可能です。
                </p>
              </div>
